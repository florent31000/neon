...
class WebRTCDataChannel:
    ...
    async def wait_datachannel_open(self, timeout=5):
        ...
        try:
            ...
            raise TimeoutError("Data channel did not open in time")
    ...
    def set_decoder(self, decoder_type):
        ...
        if UnifiedLidarDecoder is None:
            class _NoopDecoder:
                ...
                def get_decoder_name(self):
                    return "NoopDecoder"
            self.decoder = _NoopDecoder()
            print("Decoder set to: NoopDecoder (lidar disabled)")
            return
